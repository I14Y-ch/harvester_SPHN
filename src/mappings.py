# Some general codes mappings that could be helpful to import from different sources, modify this file to match your needs.
...
VALID_FORMAT_CODES = {"CSV", "DXF", "EPUB", "GDB", "GEOJSON", "GEOTIFF", "GIF", "GML", "GPKG", "GPX",
    "HTML", "INTERLIS", "JPEG", "JSON", "JSON_LD", "KML", "MP3", "N3", "ODS", "PARQUET", 
    "PDF", "PNG", "RDF", "RDF_TURTLE", "RDF_XML", "RDF_N_TRIPLES", "RDF_N_QUADS", "RDF_TRIG", "RSS", "SCHEMA_XML",
    "SDMX", "SHP", "SKOS_XML", "SPARQLQ", "SQL", "SVG", "TIFF", "TSV", "TXT", "WFS_SRVC",
    "WMS_SRVC", "WMTS_SRVC", "XLS", "XLSX", "XML", "YAML"}
